...
import com.jd.ad.demo.nativead.feed.NFeedManagerActivity;
...
public class DemoMainActivity extends BasePermissionActivity {
    ...
    private void initView() {
        ...
        bindButton(inflater, R.mipmap.ad_splash_ic, "预加载广告", EPreloadAdActivity.class, false);
        ...
        bindButton(inflater, R.mipmap.ad_feed_ic, "信息流", NFeedManagerActivity.class, false);
