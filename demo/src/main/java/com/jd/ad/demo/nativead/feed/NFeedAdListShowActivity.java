...
public class NFeedAdListShowActivity extends BaseActivity {
    private static final String TAG = "NFeedAdListShowActivity";
    ...
    private NFeedAdWrapper mFeedAdWrapper;
...
//        mCodeID = intent.getStringExtra("codeID");
    ...
    private void loadAdData() {
        new NFeedAdWrapper(this, createJADSlot()).loadAd(new NFeedAdWrapper.OnFeedAdListener() {
            @Override
            ...
            @Override
            public void onClose(NFeedAdWrapper feedAdWrapper) {
                if (feedAdWrapper != null) {
                    mDataList.remove(feedAdWrapper);
                    mAdapter.notifyDataSetChanged();
                }
            ...
            @Override
            public void onClick(NFeedAdWrapper feedAdWrapper) {
                mFeedAdWrapper = feedAdWrapper;
            }
        });
    }
    ...
    private static class MyAdapter extends BaseAdapter {
        ...
        private final float mExpressViewWidthDp;
        private final float mExpressViewHeightDp;
