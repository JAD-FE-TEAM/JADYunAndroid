...
public class ESplashMultiRequestActivity extends BaseActivity {
     ...
     * 广告列表
     */
    private final List<JADSplash> mAdList = new ArrayList<>();
    /**
     * 广告的视图集合
     */
    private final HashMap<JADSplash, View> mAdMaps = new LinkedHashMap<>();
    ...
    private void initView() {
        ...
        mNumEt = findViewById(R.id.et_num);
    ...
    private void loadAdAndShow(String slotID) {
        ...
        JADSlot slot = new JADSlot.Builder()
                //广告位ID
                .setSlotID(slotID)
                //期望个性化京东渲染广告view的size,单位dp，注意这里要保证传入尺寸符合申请的京东渲染要求的比例
