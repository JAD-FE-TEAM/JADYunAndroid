...
public class NFeedAdListActivity extends BaseActivity {
     ...
     * 广告位ID集合
     */
    private ArrayList<String> mAds = new ArrayList<>(Arrays.asList("1377798457", "1390362850","1390362612"));
...
//                String codeID = !TextUtils.isEmpty(mPlacementEt.getText()) ? mPlacementEt.getText().toString() : "";
                ...
                intent.putStringArrayListExtra("codeIDs", (ArrayList<String>) mAds);
