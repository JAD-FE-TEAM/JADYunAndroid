...
public class ESplashManagerActivity extends BaseActivity {
    private static final String TAG = "ESplashManagerActivity";
//    private static final String AD_ID = "1213176588";
    private static final String AD_ID = "896336840";//滑动
    ...
    private void initView() {
        ...
        mAdVideoBtn = findViewById(R.id.ad_video_btn);
        mAdVideoBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ESplashManagerActivity.this, ESplashVideoManagerActivity.class));
            }
        });
    ...
    private void loadAdAndShow(String slotId, float expressViewWidthDp, float expressViewHeightDp) {
        ...
        mJADSplash = new JADSplash(ESplashManagerActivity.this, slot);
        //Step3: 加载广告
        mJADSplash.loadAd(new JADSplashListener() {
            ...
            public void onRenderSuccess(View view) {
                ...
                if (!isFinishing()) {
                    ...
                    //注册Activity
                    if(mJADSplash!=null){
                        mJADSplash.bindActivity(ESplashManagerActivity.this);
                    }
                } else {
                    removeSplashAd();
                }
