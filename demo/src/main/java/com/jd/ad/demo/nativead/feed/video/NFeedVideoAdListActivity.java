 ...
 */
public class NFeedVideoAdListActivity extends BaseActivity {
    /**
     * 广告位ID集合
     */
//    private ArrayList<String> mAds = new ArrayList<>(Arrays.asList("1540514974", "1540514974", "1540514974"));
    private ArrayList<String> mAds = new ArrayList<>(Arrays.asList("1450589543", "1450589543", "1450589543"));
//    private ArrayList<String> mAds = new ArrayList<>(Arrays.asList("1377798457", "1377798457", "1377798457"));
    ...
    private void initViews() {
        ...
        headBarLayout.setTitle(R.string.n_feed_video_listview);
        ...
        mAdLoadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NFeedVideoAdListActivity.this, NFeedVideoAdListShowActivity.class);
